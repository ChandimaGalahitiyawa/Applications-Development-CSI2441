...
ActiveRecord::Schema[7.0].define(version: 2023_10_17_091834) do
  ...
  add_foreign_key "quote_categories", "categories", on_delete: :cascade
  add_foreign_key "quote_categories", "quotes", on_delete: :cascade
  add_foreign_key "quotes", "philosophers", on_delete: :cascade
